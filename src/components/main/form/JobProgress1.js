...
const errorJson =
  '{"unmaskedCreditCardData":[],"sourceCurrencyCode":["Row 55, Column C","Row 55, Column C","Row 55, Column C"],"incorrectCharacters":["Row 55, Column C"],"incorrectDates":["Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C","Row 55, Column C"]}'
...
const JobProgress1 = ({ setJobId, jobId, setMessage, MessageHeading }) => {
  ...
  if (counter >= 100) {
    stopPolling()
    setCounter(0)
    if (!originalFileName.includes('error' || 'Error')) {
      //send success
      setMessage({
        message: (
          <MessageHeading>
