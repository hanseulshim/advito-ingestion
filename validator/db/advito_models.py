...
class AdvitoApplicationTemplate(Base):
    __tablename__ = 'advito_application_template'

    id = Column(BigInteger, primary_key=True)
    advito_application_id = Column(ForeignKey('advito_application.id'), nullable=False)
    template_name = Column(String(32), nullable=False)
    template_category = Column(String(32), nullable=False)
    template_note = Column(String(255))
...
class AdvitoApplicationTemplateColumn(Base):
    __tablename__ = 'advito_application_template_column'
    __table_args__ = (
        UniqueConstraint('advito_application_template_id', 'column_name'),
        UniqueConstraint('advito_application_template_id', 'column_order')
    )

    id = Column(BigInteger, primary_key=True)
    advito_application_template_id = Column(ForeignKey('advito_application_template.id'))
    column_name = Column(String(256), nullable=False)
    stage_column_name = Column(String(256))
    column_order = Column(Integer, nullable=False)
    data_type = Column(String(256), nullable=False)
...
class AdvitoApplicationTemplateSource(Base):
    __tablename__ = 'advito_application_template_source'

    id = Column(BigInteger, primary_key=True)
    advito_application_template_id = Column(ForeignKey('advito_application_template.id'), nullable=False)
    source_name = Column(String(128), nullable=False)
    source_tag = Column(String(16))
