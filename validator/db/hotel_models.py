...
class StageProcessClientFeedback(Base):
    __tablename__ = 'stage_process_client_feedback'

    id = Column(BigInteger, primary_key=True)
    job_ingestion_id = Column(BigInteger)
    is_processed = Column(Boolean, server_default=text("false"))
    clientcode = Column(String, index=True)
    contract_year = Column(String, index=True)
    client_recommendation = Column(String)
    client_comments = Column(String)
    consultant_recommendation = Column(String)
    consultant_comments = Column(String)
    requested_rate = Column(String)
    requested_rate_type = Column(String)
    propcode = Column(String)
    comments_hotel = Column(String)
    comments_corp = Column(String)
    propname = Column(String)
    propadd1 = Column(String)
    propcity = Column(String)
    propcountry = Column(String)
    rate_curr = Column(String)
    dynamic_pricing = Column(String)
    dynamic_pct_discount = Column(String)
    roomtype1define = Column(String)
    roomtype1number = Column(String)
    roomtype2define = Column(String)
    roomtype2number = Column(String)
    roomtype3define = Column(String)
    roomtype3number = Column(String)
    season1start = Column(String)
    season1end = Column(String)
    lra_s1_rt1_sgl = Column(String)
    lra_s1_rt1_dbl = Column(String)
    lra_s1_rt2_sgl = Column(String)
    lra_s1_rt2_dbl = Column(String)
    lra_s1_rt3_sgl = Column(String)
    lra_s1_rt3_dbl = Column(String)
    nlra_s1_rt1_sgl = Column(String)
    nlra_s1_rt1_dbl = Column(String)
    nlra_s1_rt2_sgl = Column(String)
    nlra_s1_rt2_dbl = Column(String)
    nlra_s1_rt3_sgl = Column(String)
    nlra_s1_rt3_dbl = Column(String)
    season2start = Column(String)
    season2end = Column(String)
    lra_s2_rt1_sgl = Column(String)
    lra_s2_rt1_dbl = Column(String)
    lra_s2_rt2_sgl = Column(String)
    lra_s2_rt2_dbl = Column(String)
    lra_s2_rt3_sgl = Column(String)
    lra_s2_rt3_dbl = Column(String)
    nlra_s2_rt1_sgl = Column(String)
    nlra_s2_rt1_dbl = Column(String)
    nlra_s2_rt2_sgl = Column(String)
    nlra_s2_rt2_dbl = Column(String)
    nlra_s2_rt3_sgl = Column(String)
    nlra_s2_rt3_dbl = Column(String)
    season3start = Column(String)
    season3end = Column(String)
    lra_s3_rt1_sgl = Column(String)
    lra_s3_rt1_dbl = Column(String)
    lra_s3_rt2_sgl = Column(String)
    lra_s3_rt2_dbl = Column(String)
    lra_s3_rt3_sgl = Column(String)
    lra_s3_rt3_dbl = Column(String)
    nlra_s3_rt1_sgl = Column(String)
    nlra_s3_rt1_dbl = Column(String)
    nlra_s3_rt2_sgl = Column(String)
    nlra_s3_rt2_dbl = Column(String)
    nlra_s3_rt3_sgl = Column(String)
    nlra_s3_rt3_dbl = Column(String)
    season4start = Column(String)
    season4end = Column(String)
    lra_s4_rt1_sgl = Column(String)
    lra_s4_rt1_dbl = Column(String)
    lra_s4_rt2_sgl = Column(String)
    lra_s4_rt2_dbl = Column(String)
    lra_s4_rt3_sgl = Column(String)
    lra_s4_rt3_dbl = Column(String)
    nlra_s4_rt1_sgl = Column(String)
    nlra_s4_rt1_dbl = Column(String)
    nlra_s4_rt2_sgl = Column(String)
    nlra_s4_rt2_dbl = Column(String)
    nlra_s4_rt3_sgl = Column(String)
    nlra_s4_rt3_dbl = Column(String)
    season5start = Column(String)
    season5end = Column(String)
    lra_s5_rt1_sgl = Column(String)
    lra_s5_rt1_dbl = Column(String)
    lra_s5_rt2_sgl = Column(String)
    lra_s5_rt2_dbl = Column(String)
    lra_s5_rt3_sgl = Column(String)
    lra_s5_rt3_dbl = Column(String)
    nlra_s5_rt1_sgl = Column(String)
    nlra_s5_rt1_dbl = Column(String)
    nlra_s5_rt2_sgl = Column(String)
    nlra_s5_rt2_dbl = Column(String)
    nlra_s5_rt3_sgl = Column(String)
    nlra_s5_rt3_dbl = Column(String)
    commissionable = Column(String)
    comm_pct_client = Column(String)
    load_gds = Column(String)
    walk_hotel = Column(String)
    walk_tax = Column(String)
    walk_trans = Column(String)
    walk_call = Column(String)
    canc_pol = Column(String)
    earlyck_fee = Column(String)
    earlyck_uom = Column(String)
    earlyck_include = Column(String)
    lodgtx_fee = Column(String)
    lodgtx_uom = Column(String)
    lodgtx_include = Column(String)
    statetx_fee = Column(String)
    statetx_uom = Column(String)
    statetx_include = Column(String)
    citytx_fee = Column(String)
    citytx_uom = Column(String)
    citytx_include = Column(String)
    vatgstrm_fee = Column(String)
    vatgstrm_uom = Column(String)
    vatgstrm_include = Column(String)
    vatgstfb_fee = Column(String)
    vatgstfb_uom = Column(String)
    vatgstfb_include = Column(String)
    service_fee = Column(String)
    service_uom = Column(String)
    service_include = Column(String)
    occ_fee = Column(String)
    occ_uom = Column(String)
    occ_include = Column(String)
    othertx_fee = Column(String)
    othertx_fee_uom = Column(String)
    othertx_fee_desc = Column(String)
    othertx_fee_incl = Column(String)
    parkattend = Column(String)
    park_fee = Column(String)
    park_include = Column(String)
    break_include = Column(String)
    break_fee = Column(String)
    break_type = Column(String)
    fiton_cent = Column(String)
    fitness_fee_on = Column(String)
    fitness_include_on = Column(String)
    local_phone_include = Column(String)
    toll_card_call_include = Column(String)
    highspeed_inroom = Column(String)
    highspeed_inroom_num = Column(String)
    hsia_fee = Column(String)
    hsia_include = Column(String)
    wireless = Column(String)
    wireless_num = Column(String)
    wireless_fee = Column(String)
    wireless_include = Column(String)
    airtrans_fee = Column(String)
    airtrans_include = Column(String)
    airtrans_describe = Column(String)
    offtrans_include = Column(String)
    rate_subs = Column(String)
    rate_perso = Column(String)
    rate_consu = Column(String)
    rate_retir = Column(String)
    userdefined1 = Column(String)
    userdefined2 = Column(String)
    userdefined3 = Column(String)
    userdefined4 = Column(String)
    userdefined5 = Column(String)
    userdefined6 = Column(String)
    userdefined7 = Column(String)
    userdefined8 = Column(String)
    userdefined9 = Column(String)
    userdefined10 = Column(String)
    userdefined11 = Column(String)
    userdefined12 = Column(String)
    userdefined13 = Column(String)
    userdefined14 = Column(String)
    userdefined15 = Column(String)
    userdefined16 = Column(String)
    userdefined17 = Column(String)
    userdefined18 = Column(String)
    userdefined19 = Column(String)
    userdefined20 = Column(String)
    userdefined21 = Column(String)
    userdefined22 = Column(String)
    userdefined23 = Column(String)
    userdefined24 = Column(String)
    userdefined25 = Column(String)
    userdefined26 = Column(String)
    userdefined27 = Column(String)
    userdefined28 = Column(String)
    userdefined29 = Column(String)
    userdefined30 = Column(String)
    parkgates = Column(String)
    parkpatrol = Column(String)
    parklights = Column(String)
    lastroomavail_bd = Column(String)
    bd1_start = Column(String)
    bd1_end = Column(String)
    bd1_rt1_sgl = Column(String)
    bd1_rt1_dbl = Column(String)
    bd1_rt2_sgl = Column(String)
    bd1_rt2_dbl = Column(String)
    bd1_rt3_sgl = Column(String)
    bd1_rt3_dbl = Column(String)
    bd2_start = Column(String)
    bd2_end = Column(String)
    bd2_rt1_sgl = Column(String)
    bd2_rt1_dbl = Column(String)
    bd2_rt2_sgl = Column(String)
    bd2_rt2_dbl = Column(String)
    bd2_rt3_sgl = Column(String)
    bd2_rt3_dbl = Column(String)
    bd3_start = Column(String)
    bd3_end = Column(String)
    bd3_rt1_sgl = Column(String)
    bd3_rt1_dbl = Column(String)
    bd3_rt2_sgl = Column(String)
    bd3_rt2_dbl = Column(String)
    bd3_rt3_sgl = Column(String)
    bd3_rt3_dbl = Column(String)
    bd4_start = Column(String)
    bd4_end = Column(String)
    bd4_rt1_sgl = Column(String)
    bd4_rt1_dbl = Column(String)
    bd4_rt2_sgl = Column(String)
    bd4_rt2_dbl = Column(String)
    bd4_rt3_sgl = Column(String)
    bd4_rt3_dbl = Column(String)
    bd5_start = Column(String)
    bd5_end = Column(String)
    bd5_rt1_sgl = Column(String)
    bd5_rt1_dbl = Column(String)
    bd5_rt2_sgl = Column(String)
    bd5_rt2_dbl = Column(String)
    bd5_rt3_sgl = Column(String)
    bd5_rt3_dbl = Column(String)
    bd6_start = Column(String)
    bd6_end = Column(String)
    bd6_rt1_sgl = Column(String)
    bd6_rt1_dbl = Column(String)
    bd6_rt2_sgl = Column(String)
    bd6_rt2_dbl = Column(String)
    bd6_rt3_sgl = Column(String)
    bd6_rt3_dbl = Column(String)
    bd7_start = Column(String)
    bd7_end = Column(String)
    bd7_rt1_sgl = Column(String)
    bd7_rt1_dbl = Column(String)
    bd7_rt2_sgl = Column(String)
    bd7_rt2_dbl = Column(String)
    bd7_rt3_sgl = Column(String)
    bd7_rt3_dbl = Column(String)
    bd8_start = Column(String)
    bd8_end = Column(String)
    bd8_rt1_sgl = Column(String)
    bd8_rt1_dbl = Column(String)
    bd8_rt2_sgl = Column(String)
    bd8_rt2_dbl = Column(String)
    bd8_rt3_sgl = Column(String)
    bd8_rt3_dbl = Column(String)
    bd9_start = Column(String)
    bd9_end = Column(String)
    bd9_rt1_sgl = Column(String)
    bd9_rt1_dbl = Column(String)
    bd9_rt2_sgl = Column(String)
    bd9_rt2_dbl = Column(String)
    bd9_rt3_sgl = Column(String)
    bd9_rt3_dbl = Column(String)
    bd10_start = Column(String)
    bd10_end = Column(String)
    bd10_rt1_sgl = Column(String)
    bd10_rt1_dbl = Column(String)
    bd10_rt2_sgl = Column(String)
    bd10_rt2_dbl = Column(String)
    bd10_rt3_sgl = Column(String)
    bd10_rt3_dbl = Column(String)
    los2min_es = Column(String)
    los2max_es = Column(String)
    los3min_es = Column(String)
    los3max_es = Column(String)
    los4min_es = Column(String)
    los4max_es = Column(String)
    season1start_es = Column(String)
    season1end_es = Column(String)
    lra_s1_rt1_l2_es_sgl = Column(String)
    lra_s1_rt1_l2_es_dbl = Column(String)
    lra_s1_rt2_l2_es_sgl = Column(String)
    lra_s1_rt2_l2_es_dbl = Column(String)
    lra_s1_rt3_l2_es_sgl = Column(String)
    lra_s1_rt3_l2_es_dbl = Column(String)
    nlra_s1_rt1_l2_es_sgl = Column(String)
    nlra_s1_rt1_l2_es_dbl = Column(String)
    nlra_s1_rt2_l2_es_sgl = Column(String)
    nlra_s1_rt2_l2_es_dbl = Column(String)
    nlra_s1_rt3_l2_es_sgl = Column(String)
    nlra_s1_rt3_l2_es_dbl = Column(String)
    lra_s1_rt1_l3_es_sgl = Column(String)
    lra_s1_rt1_l3_es_dbl = Column(String)
    lra_s1_rt2_l3_es_sgl = Column(String)
    lra_s1_rt2_l3_es_dbl = Column(String)
    lra_s1_rt3_l3_es_sgl = Column(String)
    lra_s1_rt3_l3_es_dbl = Column(String)
    nlra_s1_rt1_l3_es_sgl = Column(String)
    nlra_s1_rt1_l3_es_dbl = Column(String)
    nlra_s1_rt2_l3_es_sgl = Column(String)
    nlra_s1_rt2_l3_es_dbl = Column(String)
    nlra_s1_rt3_l3_es_sgl = Column(String)
    nlra_s1_rt3_l3_es_dbl = Column(String)
    lra_s1_rt1_l4_es_sgl = Column(String)
    lra_s1_rt1_l4_es_dbl = Column(String)
    lra_s1_rt2_l4_es_sgl = Column(String)
    lra_s1_rt2_l4_es_dbl = Column(String)
    lra_s1_rt3_l4_es_sgl = Column(String)
    lra_s1_rt3_l4_es_dbl = Column(String)
    nlra_s1_rt1_l4_es_sgl = Column(String)
    nlra_s1_rt1_l4_es_dbl = Column(String)
    nlra_s1_rt2_l4_es_sgl = Column(String)
    nlra_s1_rt2_l4_es_dbl = Column(String)
    nlra_s1_rt3_l4_es_sgl = Column(String)
    nlra_s1_rt3_l4_es_dbl = Column(String)
    season2start_es = Column(String)
    season2end_es = Column(String)
    lra_s2_rt1_l2_es_sgl = Column(String)
    lra_s2_rt1_l2_es_dbl = Column(String)
    lra_s2_rt2_l2_es_sgl = Column(String)
    lra_s2_rt2_l2_es_dbl = Column(String)
    lra_s2_rt3_l2_es_sgl = Column(String)
    lra_s2_rt3_l2_es_dbl = Column(String)
    nlra_s2_rt1_l2_es_sgl = Column(String)
    nlra_s2_rt1_l2_es_dbl = Column(String)
    nlra_s2_rt2_l2_es_sgl = Column(String)
    nlra_s2_rt2_l2_es_dbl = Column(String)
    nlra_s2_rt3_l2_es_sgl = Column(String)
    nlra_s2_rt3_l2_es_dbl = Column(String)
    lra_s2_rt1_l3_es_sgl = Column(String)
    lra_s2_rt1_l3_es_dbl = Column(String)
    lra_s2_rt2_l3_es_sgl = Column(String)
    lra_s2_rt2_l3_es_dbl = Column(String)
    lra_s2_rt3_l3_es_sgl = Column(String)
    lra_s2_rt3_l3_es_dbl = Column(String)
    nlra_s2_rt1_l3_es_sgl = Column(String)
    nlra_s2_rt1_l3_es_dbl = Column(String)
    nlra_s2_rt2_l3_es_sgl = Column(String)
    nlra_s2_rt2_l3_es_dbl = Column(String)
    nlra_s2_rt3_l3_es_sgl = Column(String)
    nlra_s2_rt3_l3_es_dbl = Column(String)
    lra_s2_rt1_l4_es_sgl = Column(String)
    lra_s2_rt1_l4_es_dbl = Column(String)
    lra_s2_rt2_l4_es_sgl = Column(String)
    lra_s2_rt2_l4_es_dbl = Column(String)
    lra_s2_rt3_l4_es_sgl = Column(String)
    lra_s2_rt3_l4_es_dbl = Column(String)
    nlra_s2_rt1_l4_es_sgl = Column(String)
    nlra_s2_rt1_l4_es_dbl = Column(String)
    nlra_s2_rt2_l4_es_sgl = Column(String)
    nlra_s2_rt2_l4_es_dbl = Column(String)
    nlra_s2_rt3_l4_es_sgl = Column(String)
    nlra_s2_rt3_l4_es_dbl = Column(String)
    season3start_es = Column(String)
    season3end_es = Column(String)
    lra_s3_rt1_l2_es_sgl = Column(String)
    lra_s3_rt1_l2_es_dbl = Column(String)
    lra_s3_rt2_l2_es_sgl = Column(String)
    lra_s3_rt2_l2_es_dbl = Column(String)
    lra_s3_rt3_l2_es_sgl = Column(String)
    lra_s3_rt3_l2_es_dbl = Column(String)
    nlra_s3_rt1_l2_es_sgl = Column(String)
    nlra_s3_rt1_l2_es_dbl = Column(String)
    nlra_s3_rt2_l2_es_sgl = Column(String)
    nlra_s3_rt2_l2_es_dbl = Column(String)
    nlra_s3_rt3_l2_es_sgl = Column(String)
    nlra_s3_rt3_l2_es_dbl = Column(String)
    lra_s3_rt1_l3_es_sgl = Column(String)
    lra_s3_rt1_l3_es_dbl = Column(String)
    lra_s3_rt2_l3_es_sgl = Column(String)
    lra_s3_rt2_l3_es_dbl = Column(String)
    lra_s3_rt3_l3_es_sgl = Column(String)
    lra_s3_rt3_l3_es_dbl = Column(String)
    nlra_s3_rt1_l3_es_sgl = Column(String)
    nlra_s3_rt1_l3_es_dbl = Column(String)
    nlra_s3_rt2_l3_es_sgl = Column(String)
    nlra_s3_rt2_l3_es_dbl = Column(String)
    nlra_s3_rt3_l3_es_sgl = Column(String)
    nlra_s3_rt3_l3_es_dbl = Column(String)
    lra_s3_rt1_l4_es_sgl = Column(String)
    lra_s3_rt1_l4_es_dbl = Column(String)
    lra_s3_rt2_l4_es_sgl = Column(String)
    lra_s3_rt2_l4_es_dbl = Column(String)
    lra_s3_rt3_l4_es_sgl = Column(String)
    lra_s3_rt3_l4_es_dbl = Column(String)
    nlra_s3_rt1_l4_es_sgl = Column(String)
    nlra_s3_rt1_l4_es_dbl = Column(String)
    nlra_s3_rt2_l4_es_sgl = Column(String)
    nlra_s3_rt2_l4_es_dbl = Column(String)
    nlra_s3_rt3_l4_es_sgl = Column(String)
    nlra_s3_rt3_l4_es_dbl = Column(String)
    season4start_es = Column(String)
    season4end_es = Column(String)
    lra_s4_rt1_l2_es_sgl = Column(String)
    lra_s4_rt1_l2_es_dbl = Column(String)
    lra_s4_rt2_l2_es_sgl = Column(String)
    lra_s4_rt2_l2_es_dbl = Column(String)
    lra_s4_rt3_l2_es_sgl = Column(String)
    lra_s4_rt3_l2_es_dbl = Column(String)
    nlra_s4_rt1_l2_es_sgl = Column(String)
    nlra_s4_rt1_l2_es_dbl = Column(String)
    nlra_s4_rt2_l2_es_sgl = Column(String)
    nlra_s4_rt2_l2_es_dbl = Column(String)
    nlra_s4_rt3_l2_es_sgl = Column(String)
    nlra_s4_rt3_l2_es_dbl = Column(String)
    lra_s4_rt1_l3_es_sgl = Column(String)
    lra_s4_rt1_l3_es_dbl = Column(String)
    lra_s4_rt2_l3_es_sgl = Column(String)
    lra_s4_rt2_l3_es_dbl = Column(String)
    lra_s4_rt3_l3_es_sgl = Column(String)
    lra_s4_rt3_l3_es_dbl = Column(String)
    nlra_s4_rt1_l3_es_sgl = Column(String)
    nlra_s4_rt1_l3_es_dbl = Column(String)
    nlra_s4_rt2_l3_es_sgl = Column(String)
    nlra_s4_rt2_l3_es_dbl = Column(String)
    nlra_s4_rt3_l3_es_sgl = Column(String)
    nlra_s4_rt3_l3_es_dbl = Column(String)
    lra_s4_rt1_l4_es_sgl = Column(String)
    lra_s4_rt1_l4_es_dbl = Column(String)
    lra_s4_rt2_l4_es_sgl = Column(String)
    lra_s4_rt2_l4_es_dbl = Column(String)
    lra_s4_rt3_l4_es_sgl = Column(String)
    lra_s4_rt3_l4_es_dbl = Column(String)
    nlra_s4_rt1_l4_es_sgl = Column(String)
    nlra_s4_rt1_l4_es_dbl = Column(String)
    nlra_s4_rt2_l4_es_sgl = Column(String)
    nlra_s4_rt2_l4_es_dbl = Column(String)
    nlra_s4_rt3_l4_es_sgl = Column(String)
    nlra_s4_rt3_l4_es_dbl = Column(String)
    season5start_es = Column(String)
    season5end_es = Column(String)
    lra_s5_rt1_l2_es_sgl = Column(String)
    lra_s5_rt1_l2_es_dbl = Column(String)
    lra_s5_rt2_l2_es_sgl = Column(String)
    lra_s5_rt2_l2_es_dbl = Column(String)
    lra_s5_rt3_l2_es_sgl = Column(String)
    lra_s5_rt3_l2_es_dbl = Column(String)
    nlra_s5_rt1_l2_es_sgl = Column(String)
    nlra_s5_rt1_l2_es_dbl = Column(String)
    nlra_s5_rt2_l2_es_sgl = Column(String)
    nlra_s5_rt2_l2_es_dbl = Column(String)
    nlra_s5_rt3_l2_es_sgl = Column(String)
    nlra_s5_rt3_l2_es_dbl = Column(String)
    lra_s5_rt1_l3_es_sgl = Column(String)
    lra_s5_rt1_l3_es_dbl = Column(String)
    lra_s5_rt2_l3_es_sgl = Column(String)
    lra_s5_rt2_l3_es_dbl = Column(String)
    lra_s5_rt3_l3_es_sgl = Column(String)
    lra_s5_rt3_l3_es_dbl = Column(String)
    nlra_s5_rt1_l3_es_sgl = Column(String)
    nlra_s5_rt1_l3_es_dbl = Column(String)
    nlra_s5_rt2_l3_es_sgl = Column(String)
    nlra_s5_rt2_l3_es_dbl = Column(String)
    nlra_s5_rt3_l3_es_sgl = Column(String)
    nlra_s5_rt3_l3_es_dbl = Column(String)
    lra_s5_rt1_l4_es_sgl = Column(String)
    lra_s5_rt1_l4_es_dbl = Column(String)
    lra_s5_rt2_l4_es_sgl = Column(String)
    lra_s5_rt2_l4_es_dbl = Column(String)
    lra_s5_rt3_l4_es_sgl = Column(String)
    lra_s5_rt3_l4_es_dbl = Column(String)
    nlra_s5_rt1_l4_es_sgl = Column(String)
    nlra_s5_rt1_l4_es_dbl = Column(String)
    nlra_s5_rt2_l4_es_sgl = Column(String)
    nlra_s5_rt2_l4_es_dbl = Column(String)
    nlra_s5_rt3_l4_es_sgl = Column(String)
    nlra_s5_rt3_l4_es_dbl = Column(String)
    created = Column(TIMESTAMP(precision=6), nullable=False, server_default=text("now()"))
    modified = Column(TIMESTAMP(precision=6), nullable=False, server_default=text("now()"))
